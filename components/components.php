...
function render_whatsapp_button(array $site): void
{
    ...
    <a class="pulse fixed bottom-6 right-6 z-50 grid size-16 place-items-center rounded-full bg-[#25d366] text-white shadow-2xl transition hover:scale-110" href="<?= e(wa_link($site['admin_whatsapp'], $message)) ?>" target="_blank" rel="noopener" aria-label="Chat WhatsApp">
        <svg class="size-8" viewBox="0 0 32 32" fill="currentColor" aria-hidden="true">
            <path d="M16 3.2A12.7 12.7 0 0 0 5.2 26.6l-1.1 4.2 4.3-1.1A12.7 12.7 0 1 0 16 3.2Zm0 23.3c-2 0-3.8-.5-5.4-1.5l-.4-.2-2.5.7.7-2.4-.3-.4a10.5 10.5 0 1 1 7.9 3.8Zm5.8-7.9c-.3-.2-1.9-.9-2.2-1-.3-.1-.5-.2-.7.2-.2.3-.8 1-.9 1.2-.2.2-.3.2-.6.1-.3-.2-1.3-.5-2.5-1.5-.9-.8-1.5-1.8-1.7-2.1-.2-.3 0-.5.1-.6l.5-.6c.2-.2.2-.3.3-.5.1-.2.1-.4 0-.6-.1-.2-.7-1.7-1-2.3-.3-.6-.5-.5-.7-.5h-.6c-.2 0-.6.1-.9.4-.3.3-1.2 1.2-1.2 3 0 1.8 1.3 3.5 1.5 3.7.2.2 2.6 4 6.2 5.5.9.4 1.6.6 2.1.7.9.3 1.7.2 2.3.1.7-.1 1.9-.8 2.2-1.5.3-.7.3-1.4.2-1.5-.1-.2-.3-.3-.6-.4Z"/>
        </svg>
    </a>
    <?php
}
