...
function render_whatsapp_button(array $site): void
{
    ...
    ?>
    <a class="pulse fixed bottom-6 right-6 z-50 grid size-16 place-items-center rounded-full bg-[#25d366] text-sm font-black text-white shadow-2xl transition hover:scale-110" href="<?= e(wa_link($site['admin_whatsapp'], $message)) ?>" target="_blank" rel="noopener" aria-label="Chat WhatsApp">WA</a>
    <?php
}
